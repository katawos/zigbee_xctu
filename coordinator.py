...
def run_diff(img_names, resolution, payload_size, experiment_sub_name, method = None, quality = None, transmission = "synch", transmission_sleep = ASYNC_DELAY, comparison_image = False, diff_map = False, TO_coord = None, TO_recv = None):
    # image_x = resolution[0]
    # image_y = resolution[1]
    ...
    #since images are already 1080p -> get shape
    image_y = img1.shape[0] #height
    image_x = img1.shape[1] #width
...
def test_diff_with_compr(experiment_name, img_names, TO_coord = 0, TO_recv = 0):
    ...
    res = "240p" 
    # synch
    exper_sub_name = TRANSMISSION_TYPE[0] + f"_res{res}_diffTest_street"
   ...
   #synch JPEG quality=55 diff images
    ...
    run_diff(img_names = img_names, resolution= RESOLUTIONS[res], payload_size = 84, experiment_sub_name = exper_sub_name, method = "JPEG", quality = 85, transmission = TRANSMISSION_TYPE[0], diff_map = True, TO_coord = TO_coord, TO_recv = TO_recv)
    ...
    # run_diff(img_names = img_names, resolution= RESOLUTIONS[res], payload_size = 84, experiment_sub_name = exper_sub_name, method = "JPEG", quality = 85, transmission = TRANSMISSION_TYPE[1], diff_map = True, TO_coord = TO_coord, TO_recv = TO_recv)
...
if __name__ == '__main__':
    ...
    img_names_first_second_frame = ["street-1.jpg", "street-2.jpg"]
    # (1) diff test
